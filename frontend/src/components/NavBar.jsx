                ...
                <div className='relative group' >
                    ...
                    <div className='absolute right-0 hidden pt-4 group-hover:block dropdown-menu'>
                        <div className='flex flex-col gap-2 px-5 py-3 text-gray-500 rounded w-36 bg-slate-100'>
                            <button className='cursor-pointer hover:text-black ' onClick={()=>{navigate('/profile')}}>Profile</button>
                            <button className='cursor-pointer hover:text-black ' onClick={()=>{navigate('/orders')}}>Orders</button>
                            <button className='cursor-pointer hover:text-black ' onClick={()=>{handleLogout}}>Logout</button>
                        </div>
                    </div>
                </div>
